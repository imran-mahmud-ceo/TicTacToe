...
CREATE TABLE [dbo].[GameRecords] (
    [Id]            INT            IDENTITY (1, 1) NOT NULL,
    [BoardState]    NVARCHAR (MAX) NOT NULL,
    [CreatedAt]     DATETIME2 (7)  NOT NULL,
    [UserId]        NVARCHAR (MAX) NULL,
    [CurrentPlayer] NVARCHAR (MAX) DEFAULT (N'') NOT NULL,
    [Message]       NVARCHAR (MAX) DEFAULT (N'') NOT NULL,
    [Winner]        NVARCHAR (MAX) NULL,
    CONSTRAINT [PK_GameRecords] PRIMARY KEY CLUSTERED ([Id] ASC)
);
GO
...
/* 2. DEPENDENT TABLES (Create these after Users and Roles) */
